...
During the kick-off call, make sure the person on the client's team assigned to the project understands what the Scrum master and the Scrum team expect from them. Some key points to cover:
