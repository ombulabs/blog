...
If you have [any other commands that need to be run](https://docs.docker.com/engine/reference/builder/#run), you can use the `CMD` command.  Let's use it to install [RVM](https://rvm.io/):
